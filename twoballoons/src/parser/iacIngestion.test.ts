...
`;
    ...
    it('should handle malformed or empty YAML gracefully', () => {
      const yaml = `
---
apiVersion: v1
---
...
`;
      const result = parseKubernetesYaml(yaml);
      // Depending on logic, it should probably return 0 or default types, we check it doesn't crash
...
`;
    ...
    it('should handle empty or no-service compose files', () => {
...
`;
    ...
    it('should handle HCL with no resources', () => {
      const hcl = `
variable "test" {
  default = "value"
}
